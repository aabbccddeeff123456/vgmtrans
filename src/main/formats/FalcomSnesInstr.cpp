...
FalcomSnesInstr::FalcomSnesInstr(VGMInstrSet *instrSet,
                                 ...
                                 uint32_t spcDirAddr,
                                 const std::wstring &name) :
    VGMInstr(instrSet, offset, 0, theBank, theInstrNum, name), version(ver),
    srcn(srcn),
    spcDirAddr(spcDirAddr) {
}
...
FalcomSnesRgn::FalcomSnesRgn(FalcomSnesInstr *instr,
                             ...
                             uint32_t offset,
                             uint8_t srcn) :
    VGMRgn(instr, offset, 0), version(ver) {
